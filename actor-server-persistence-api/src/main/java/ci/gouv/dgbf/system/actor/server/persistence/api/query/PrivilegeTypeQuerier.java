...
@Queries(value = {
	@org.cyk.utility.persistence.annotation.Query(tupleClass = PrivilegeType.class,name = PrivilegeTypeQuerier.QUERY_NAME_READ_ORDER_BY_CODE_ASCENDING,value = "SELECT t FROM PrivilegeType t ORDER BY t.code ASC")
	,@org.cyk.utility.persistence.annotation.Query(tupleClass = PrivilegeType.class,name = PrivilegeTypeQuerier.QUERY_NAME_READ_ORDER_BY_ORDER_NUMBER_ASCENDING,value = "SELECT t FROM PrivilegeType t ORDER BY t.orderNumber ASC")
})
