...
public interface ProfileFunctionQuerier extends Querier {
	...
	static void initialize() {
		QueryManager.getInstance().register(Query.build(Query.FIELD_IDENTIFIER,QUERY_IDENTIFIER_READ_BY_PROFILE_CODE_BY_FUNCTION_CODE
		...
		QueryManager.getInstance().register(Query.build(Query.FIELD_IDENTIFIER,QUERY_IDENTIFIER_COUNT_BY_PROFILES_TYPES_CODES_BY_FUNCTIONS_CODES
				,Query.FIELD_TUPLE_CLASS,ProfileFunction.class,Query.FIELD_RESULT_CLASS,Long.class
