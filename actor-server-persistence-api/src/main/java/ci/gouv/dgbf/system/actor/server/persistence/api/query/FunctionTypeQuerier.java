...
@Queries(value = {
		@org.cyk.utility.__kernel__.persistence.query.annotation.Query(tupleClass = FunctionType.class,name = FunctionTypeQuerier.QUERY_NAME_READ_ORDER_BY_CODE_ASCENDING,value = "SELECT t FROM FunctionType t ORDER BY t.code ASC")
})
public interface FunctionTypeQuerier extends Querier {
	...
	public static abstract class AbstractImpl extends AbstractObject implements FunctionTypeQuerier,Serializable {	
		@Override
