...
@Queries(value = {
		@org.cyk.utility.__kernel__.persistence.query.annotation.Query(tupleClass = IdentityGroup.class,name = IdentityGroupQuerier.QUERY_NAME_READ,value = "SELECT t FROM IdentityGroup t ORDER BY t.name ASC")
})
