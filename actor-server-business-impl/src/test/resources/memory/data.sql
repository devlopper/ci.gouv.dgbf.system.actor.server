...
Insert into VM_APP_EX_IMPUTATION (LDEP_ID,IDENTIFIANT,EXERCICE,CODE,LIBELLE,SECTION_IDENTIFIANT,SECTION_CODE,SECTION_CODE_LIBELLE,CATEGORIE_BUDGET_IDENTIFIANT) values ('1','1',2021,'1','1','327','327','327 Budget','CB01');
Insert into VM_APP_EX_IMPUTATION (LDEP_ID,IDENTIFIANT,EXERCICE,CODE,LIBELLE,SECTION_IDENTIFIANT,SECTION_CODE,SECTION_CODE_LIBELLE,CATEGORIE_BUDGET_IDENTIFIANT) values ('2','2',2021,'2','2','328','328','328 Budget','CB01');

Insert into POSTE (IDENTIFIANT,CODE,LIBELLE,FONCTION,DOMAINE,NUMERO_DOCUMENT,CATEGORIE_BUDGET) values ('1','1','Assistant','AGC','13010222',1,'CB01');
Insert into POSTE (IDENTIFIANT,CODE,LIBELLE,FONCTION,DOMAINE,NUMERO_DOCUMENT,CATEGORIE_BUDGET) values ('C300000','C300000','Gestionnaire','CF','13010223',1,'CB01');
Insert into POSTE (IDENTIFIANT,CODE,LIBELLE,FONCTION,DOMAINE,NUMERO_DOCUMENT,CATEGORIE_BUDGET) values ('A3000000','A3000000','Assistant','ACF','13010223',1,'CB01');

Insert into AFFECTATIONS (IDENTIFIANT,IMPUTATION) values ('1','1');
Insert into AFFECTATIONS (IDENTIFIANT,IMPUTATION) values ('override0','2');