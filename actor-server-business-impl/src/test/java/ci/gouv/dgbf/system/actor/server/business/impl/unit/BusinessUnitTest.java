...
public class BusinessUnitTest extends AbstractUnitTest {
	...
	public void create_profileType() throws Exception{
		...
		profileType.setName("The Name");
		QueryExecutorArguments queryExecutorArguments = new QueryExecutorArguments();
		queryExecutorArguments.setEntityManager(EntityManagerGetter.getInstance().get());
		queryExecutorArguments.setObjects(List.of(profileType));
		//queryExecutorArguments.addObjects(profileType);
		
		//queryExecutorArguments.getEntityManager().getTransaction().begin();
		...
		assertThat(profileType.getName()).isEqualTo("The Name");
	}
