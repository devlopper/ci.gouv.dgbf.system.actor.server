...
public abstract class AbstractBusinessLiveIT extends AbstractBusinessIT {
    ...
    public static Archive<?> buildArchive() {
    	return new ArchiveBuilder().setPersistenceEnabled(Boolean.TRUE)
    			...
    			.addClasses(AbstractBusinessLiveIT.class,ApplicationScopeLifeCycleListener.class,EntityReaderImpl.class)
    			.build();
    }
