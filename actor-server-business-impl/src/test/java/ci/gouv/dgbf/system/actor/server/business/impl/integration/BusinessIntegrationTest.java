...
public class BusinessIntegrationTest extends AbstractBusinessArquillianIntegrationTestWithDefaultDeployment {
	...
	public void executionImputation_deriveScopeFunctionsFromModel() throws Exception {
		...
		executionImputation.setCreditManagerHolderIdentifier("GC11025125");
		...
		assertThat(executionImputation.getCreditManager().getHolderIdentifier()).isEqualTo("GC11025125");
		assertThat(executionImputation.getCreditManager().getAssistantIdentifier()).isNotBlank();
		assertThat(executionImputation.getAuthorizingOfficer()).isNull();
		assertThat(executionImputation.getFinancialController()).isNull();
		assertThat(executionImputation.getAccounting()).isNull();
		executionImputation.setCreditManagerHolderIdentifier("GC11025124");
		__inject__(ExecutionImputationBusiness.class).saveScopeFunctions(List.of(executionImputation));
		...
		assertThat(executionImputation.getCreditManager()).isNotNull();
		assertThat(executionImputation.getCreditManager().getHolderIdentifier()).isNotBlank();
		assertThat(executionImputation.getCreditManager().getHolderIdentifier()).isEqualTo("GC11025124");
		assertThat(executionImputation.getCreditManager().getAssistantIdentifier()).isNotBlank();
		assertThat(executionImputation.getAuthorizingOfficer()).isNull();
		assertThat(executionImputation.getFinancialController()).isNull();
		assertThat(executionImputation.getAccounting()).isNull();
		executionImputation.setFinancialControllerHolderIdentifier("CF327");
		__inject__(ExecutionImputationBusiness.class).saveScopeFunctions(List.of(executionImputation));
		...
		assertThat(executionImputation.getFinancialController().getHolderIdentifier()).isEqualTo("CF327");
		assertThat(executionImputation.getFinancialController().getAssistantIdentifier()).isNotBlank();	
		assertThat(executionImputation.getAccounting()).isNull();
		executionImputation.setFinancialControllerHolderIdentifier("CF101");
		__inject__(ExecutionImputationBusiness.class).saveScopeFunctions(List.of(executionImputation));
		...
		assertThat(executionImputation.getFinancialController()).isNotNull();
		assertThat(executionImputation.getFinancialController().getHolderIdentifier()).isNotBlank();
		assertThat(executionImputation.getFinancialController().getHolderIdentifier()).isEqualTo("CF101");
		assertThat(executionImputation.getFinancialController().getAssistantIdentifier()).isNotBlank();	
		assertThat(executionImputation.getAccounting()).isNull();
		executionImputation.setCreditManagerHolderIdentifier("GC11025125");
		executionImputation.setFinancialControllerHolderIdentifier("CF327");
		...
		assertThat(executionImputation.getFinancialController().getAssistantIdentifier()).isNotBlank();	
		assertThat(executionImputation.getAccounting()).isNull();
		executionImputation.setCreditManagerHolderIdentifier(null);
		executionImputation.setFinancialControllerHolderIdentifier(null);
		__inject__(ExecutionImputationBusiness.class).saveScopeFunctions(List.of(executionImputation));
	...
	public void executionImputation_saveScopeFunctions() throws Exception {
		...
		executionImputation = ExecutionImputationQuerier.getInstance().readBySystemIdentifierWithAll(ExecutionImputation.class, "i02");
		assertThat(executionImputation.getCreditManager()).isNotNull();
		assertThat(executionImputation.getCreditManager().getHolderIdentifier()).isNotNull();
		assertThat(executionImputation.getCreditManager().getHolderIdentifier()).isEqualTo("GC11025125");
		assertThat(executionImputation.getCreditManager().getAssistantIdentifier()).isNull();
		assertThat(executionImputation.getAuthorizingOfficer()).isNull();
		assertThat(executionImputation.getFinancialController()).isNull();
		assertThat(executionImputation.getAccounting()).isNull();
		executionImputation.setCreditManagerHolderIdentifier("GC11025124");
		...
		assertThat(executionImputation.getAuthorizingOfficer()).isNull();
		assertThat(executionImputation.getFinancialController()).isNotNull();
		assertThat(executionImputation.getFinancialController().getHolderIdentifier()).isNotNull();
		assertThat(executionImputation.getFinancialController().getHolderIdentifier()).isEqualTo("CF327");
		assertThat(executionImputation.getFinancialController().getAssistantIdentifier()).isNull();	
		assertThat(executionImputation.getAccounting()).isNull();
		executionImputation.setFinancialControllerHolderIdentifier("CF101");
		__inject__(ExecutionImputationBusiness.class).saveScopeFunctions(List.of(executionImputation));
