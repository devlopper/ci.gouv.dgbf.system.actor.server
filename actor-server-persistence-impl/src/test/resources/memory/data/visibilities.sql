Insert into TYPE_DOMAINE (IDENTIFIANT,CODE,LIBELLE,NUMERO_ORDRE) values ('CATEGORIE_BUDGET','CATEGORIE_BUDGET','Catégorie Budget',1);
Insert into TYPE_DOMAINE (IDENTIFIANT,CODE,LIBELLE,NUMERO_ORDRE) values ('SECTION','SECTION','Section',2);
Insert into TYPE_DOMAINE (IDENTIFIANT,CODE,LIBELLE,NUMERO_ORDRE) values ('UA','UA','Unité administrative',3);
Insert into TYPE_DOMAINE (IDENTIFIANT,CODE,LIBELLE,NUMERO_ORDRE) values ('USB','USB','Unité de spécialisation du budget',4);
Insert into TYPE_DOMAINE (IDENTIFIANT,CODE,LIBELLE,NUMERO_ORDRE) values ('ACTION','ACTION','Action',5);
Insert into TYPE_DOMAINE (IDENTIFIANT,CODE,LIBELLE,NUMERO_ORDRE) values ('ACTIVITE','ACTIVITE','Activité',6);
Insert into TYPE_DOMAINE (IDENTIFIANT,CODE,LIBELLE,NUMERO_ORDRE) values ('CATEGORIE_ACTIVITE','CATEGORIE_ACTIVITE','Catégorie Activité',7);
Insert into TYPE_DOMAINE (IDENTIFIANT,CODE,LIBELLE,NUMERO_ORDRE) values ('LOCALITE','LOCALITE','Localité',8);

Insert into VM_APP_CAT_BUDGET (IDENTIFIANT,CODE,LIBELLE) values ('cb01','cb01','CB 01');
Insert into VM_APP_DOMAINE (IDENTIFIANT,CODE,LIBELLE,TYPE) values ('cb01','cb01','CB 01','CATEGORIE_BUDGET');
Insert into VM_APP_CAT_BUDGET (IDENTIFIANT,CODE,LIBELLE) values ('cb02','cb02','CB 02');
Insert into VM_APP_DOMAINE (IDENTIFIANT,CODE,LIBELLE,TYPE) values ('cb02','cb02','CB 02','CATEGORIE_BUDGET');
Insert into VM_APP_CAT_BUDGET (IDENTIFIANT,CODE,LIBELLE) values ('cb03','cb03','CB 03');
Insert into VM_APP_DOMAINE (IDENTIFIANT,CODE,LIBELLE,TYPE) values ('cb03','cb03','CB 03','CATEGORIE_BUDGET');
Insert into VM_APP_CAT_BUDGET (IDENTIFIANT,CODE,LIBELLE) values ('cb04','cb04','CB 04');
Insert into VM_APP_DOMAINE (IDENTIFIANT,CODE,LIBELLE,TYPE) values ('cb04','cb04','CB 04','CATEGORIE_BUDGET');
Insert into VM_APP_CAT_BUDGET (IDENTIFIANT,CODE,LIBELLE) values ('cb05','cb05','CB 05');
Insert into VM_APP_DOMAINE (IDENTIFIANT,CODE,LIBELLE,TYPE) values ('cb05','cb05','CB 05','CATEGORIE_BUDGET');
...
Insert into VM_APP_SECTION (IDENTIFIANT,CODE,LIBELLE) values ('s12','s12','Section 12');
Insert into VM_APP_DOMAINE (IDENTIFIANT,CODE,LIBELLE,TYPE) values ('s12','s12','Section 12','SECTION');
...
Insert into VM_APP_USB (IDENTIFIANT,CODE,LIBELLE,SECTION,CATEGORIE) values ('usb01','usb01','usb 01','s03','cb01');
...
Insert into VM_APP_USB (IDENTIFIANT,CODE,LIBELLE,SECTION) values ('usb05','usb05','usb 05','s12');
Insert into VM_APP_DOMAINE (IDENTIFIANT,CODE,LIBELLE,TYPE) values ('usb05','usb05','usb 05','USB');
...
Insert into PROFILE (IDENTIFIANT,CODE,LIBELLE,TYPE) values ('2','P01','Profile 1','1');
Insert into PROFILE (IDENTIFIANT,CODE,LIBELLE,TYPE) values ('3','P02','Profile 2','1');

Insert into ACTEUR_PROFILE (IDENTIFIANT,ACTEUR,PROFILE) values ('1','1','1');
Insert into ACTEUR_PROFILE (IDENTIFIANT,ACTEUR,PROFILE) values ('2','1','3');

--Insert into ACTEUR_DOMAINE (IDENTIFIANT,ACTEUR,DOMAINE) values ('1000','1','cb01'); -- cb01

Insert into ACTEUR_DOMAINE (IDENTIFIANT,ACTEUR,DOMAINE) values ('10','1','s01'); -- s01
Insert into ACTEUR_DOMAINE (IDENTIFIANT,ACTEUR,DOMAINE,VISIBLE) values ('11','1','s10',1); -- s10
Insert into ACTEUR_DOMAINE (IDENTIFIANT,ACTEUR,DOMAINE) values ('12','2','s01');
Insert into ACTEUR_DOMAINE (IDENTIFIANT,ACTEUR,DOMAINE,VISIBLE) values ('13','1','s12',0);
...
Insert into ACTEUR_DOMAINE (IDENTIFIANT,ACTEUR,DOMAINE,VISIBLE) values ('31','1','usb05',0);
