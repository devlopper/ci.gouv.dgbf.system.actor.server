...
INSERT INTO DM_TYPE(IDENTIFIANT,CODE,LIBELLE,NOTIFIABLE_PAR_EMAIL) VALUES ('DPB','DPB','Demande de poste budgétaire',0);
INSERT INTO DM_TYPE(IDENTIFIANT,CODE,LIBELLE,NOTIFIABLE_PAR_EMAIL) VALUES ('DPA','DPA','Demande de poste administrative',0);
...
INSERT INTO DM_BORDEREAU(IDENTIFIANT,CODE,LIBELLE,CATEGORIE_BUDGET,SECTION,FONCTION,DATE_CREATION) VALUES ('B001','B001','B001','1','327','GC', DATE '2000-1-1');
INSERT INTO DM_BORDEREAU(IDENTIFIANT,CODE,LIBELLE,CATEGORIE_BUDGET,SECTION,FONCTION,DATE_CREATION,DATE_ENVOI) VALUES ('B002','B002','B002','1','327','GC', DATE '2000-1-1', DATE '2000-1-2');
INSERT INTO DM_BORDEREAU(IDENTIFIANT,CODE,LIBELLE,CATEGORIE_BUDGET,SECTION,FONCTION,DATE_CREATION,DATE_ENVOI,DATE_TRAITEMENT) VALUES ('B003','B003','B003','1','327','GC', DATE '2000-1-1', DATE '2000-1-2', DATE '2000-1-3');

INSERT INTO DM_DEMANDE(IDENTIFIANT,TYPE,STATUT,CODE,EMAIL,NOM,PRENOMS,MATRICULE,UNITE_ADMINISTRATIVE,DATE_CREATION,DATE_TRAITEMENT,BORDEREAU,CATEGORIE_BUDGET) VALUES ('1','DPB','A','1','kycdev@gmail.com','Komenan','Yao Christian','498721Y','DTI',DATE '2000-1-1',DATE '2000-1-2','B001','1');
...
INSERT INTO DM_DEMANDE(IDENTIFIANT,TYPE,STATUT,CODE,EMAIL,NOM,PRENOMS,MATRICULE,UNITE_ADMINISTRATIVE,DATE_CREATION,CATEGORIE_BUDGET) VALUES ('2','DPA','I','2','kycdev@gmail.com','Komenan','Yao Christian','498721Y','DTI',DATE '2000-1-2','1');
INSERT INTO DM_POSTE(IDENTIFIANT,DEMANDE,POSTE) VALUES ('4','2','AGDTI');
INSERT INTO DM_DEMANDE(IDENTIFIANT,TYPE,STATUT,CODE,EMAIL,NOM,PRENOMS,MATRICULE,UNITE_ADMINISTRATIVE,DATE_CREATION,CATEGORIE_BUDGET) VALUES ('3','DPB','I','3','test@mail.com','Zadi','Gérard','100100A','DGDDL',DATE '2000-1-1','1');
