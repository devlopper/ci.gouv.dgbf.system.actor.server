...
public class ActorPersistenceImplUnitTest extends AbstractUnitTestMemory {
	...
	public void readWhereFilter(){
		ActorQuerier.getInstance().readWhereFilter(new QueryExecutorArguments());
		//EntityReader.getInstance().readMany(Actor.class, ActorQuerier.QUERY_IDENTIFIER_READ_WHERE_FILTER);
	}
	...
	public void actors_findByCode(){
		...
		queryExecutorArguments.addProcessableTransientFieldsNames(
				Actor.FIELDS_REGISTRATION_NUMBER_FIRST_NAME_LAST_NAMES_ELECTRONIC_MAIL_ADDRESS_ADMINISTRATIVE_FUNCTION_CIVILITY_IDENTITY_GROUP_ADMINISTRATIVE_UNIT_SECTION);
