...
public class VisibilityQueryStringBuilderUnitTest extends org.cyk.utility.test.AbstractUnitTest {
	...
	@Test
	public void join(){		
		assertThat(VisibilityQueryStringBuilder.Predicate.join(Actor.class,"t",null, null, "v",null)).isEqualTo("v.actor = t");
		assertThat(VisibilityQueryStringBuilder.Predicate.join(Actor.class,"t",null, false, "v",null)).isEqualTo("v.actor = t");
		assertThat(VisibilityQueryStringBuilder.Predicate.join(Actor.class,"t",null, true, "v",null)).isEqualTo("v.actor = t AND v.scope.identifier = :scopeIdentifier");		
		assertThat(VisibilityQueryStringBuilder.Predicate.join(Scope.class,"t",null, null, "v",null)).isEqualTo("v.scope = t");
		assertThat(VisibilityQueryStringBuilder.Predicate.join(Scope.class,"t",null, false, "v",null)).isEqualTo("v.scope = t");
		assertThat(VisibilityQueryStringBuilder.Predicate.join(Scope.class,"t",null, true, "v",null)).isEqualTo("v.scope = t AND v.actor.code = :actorCode");
	}
	...
	public void selfVisible() {
		assertThat(VisibilityQueryStringBuilder.Predicate.selfVisible(Actor.class,"t",null,null)).isEqualTo("EXISTS(SELECT v.identifier FROM ActorScope v WHERE v.actor = t AND (v.visible IS NULL OR v.visible = true))");
		assertThat(VisibilityQueryStringBuilder.Predicate.selfVisible(Actor.class,"t",null,false)).isEqualTo("EXISTS(SELECT v.identifier FROM ActorScope v WHERE v.actor = t AND (v.visible IS NULL OR v.visible = true))");
		assertThat(VisibilityQueryStringBuilder.Predicate.selfVisible(Actor.class,"t",null,true)).isEqualTo("EXISTS(SELECT v.identifier FROM ActorScope v WHERE v.actor = t AND v.scope.identifier = :scopeIdentifier AND (v.visible IS NULL OR v.visible = true))");
		assertThat(VisibilityQueryStringBuilder.Predicate.selfVisible(Scope.class,"t",null,null)).isEqualTo("EXISTS(SELECT v.identifier FROM ActorScope v WHERE v.scope = t AND (v.visible IS NULL OR v.visible = true))");
		assertThat(VisibilityQueryStringBuilder.Predicate.selfVisible(Scope.class,"t",null,false)).isEqualTo("EXISTS(SELECT v.identifier FROM ActorScope v WHERE v.scope = t AND (v.visible IS NULL OR v.visible = true))");
		assertThat(VisibilityQueryStringBuilder.Predicate.selfVisible(Scope.class,"t",null,true)).isEqualTo("EXISTS(SELECT v.identifier FROM ActorScope v WHERE v.scope = t AND v.actor.code = :actorCode AND (v.visible IS NULL OR v.visible = true))");
	...
	public void parentVisible() {
		assertThat(VisibilityQueryStringBuilder.Predicate.parentVisible(Scope.class,"t",null,null,Section.class,AdministrativeUnit.class))
		...
		assertThat(VisibilityQueryStringBuilder.Predicate.parentVisible(Scope.class,"t",null,Boolean.TRUE,Section.class,AdministrativeUnit.class))
	...
	public void actor_section() {
		assertThat(VisibilityQueryStringBuilder.Predicate.actorView(ScopeType.CODE_SECTION, "t", null, null, null)).contains("SECTION");
	...
	public void sections() {
		assertThat(VisibilityQueryStringBuilder.Predicate.hasVisibleSection(Scope.class,"t",null,null,null)).doesNotContain(":actorCode");
		assertThat(VisibilityQueryStringBuilder.Predicate.hasVisibleSection(Scope.class,"t",null,true,null)).contains(":actorCode");
	}
	
	@Test
	public void administrativeUnits() {
		assertThat(VisibilityQueryStringBuilder.Predicate.hasVisibleAdministrativeUnit(Scope.class,"t",null,null,null)).doesNotContain(":actorCode");
		assertThat(VisibilityQueryStringBuilder.Predicate.hasVisibleAdministrativeUnit(Scope.class,"t",null,true,null)).contains(":actorCode");
	}
}