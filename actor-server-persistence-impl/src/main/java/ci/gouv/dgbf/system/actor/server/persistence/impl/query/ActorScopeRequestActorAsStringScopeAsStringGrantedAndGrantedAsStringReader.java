...
public class ActorScopeRequestActorAsStringScopeAsStringGrantedAndGrantedAsStringReader extends AbstractActorScopeRequestReaderImpl implements Serializable {
	...
	protected String getQueryValue() {
		...
		arguments.getTuple(Boolean.TRUE).add("ActorScopeRequest t").addJoins("JOIN Actor a ON a = t.actor","JOIN Scope s ON s = t.scope");
