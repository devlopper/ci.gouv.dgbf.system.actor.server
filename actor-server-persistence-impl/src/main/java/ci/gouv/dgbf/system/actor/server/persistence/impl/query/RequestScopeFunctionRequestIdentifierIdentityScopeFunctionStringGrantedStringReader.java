...
public class RequestScopeFunctionRequestIdentifierIdentityScopeFunctionStringGrantedStringReader extends AbstractRequestScopeFunctionReaderImpl implements Serializable {
	...
	protected QueryStringBuilder.Arguments instantiateQueryStringBuilderArguments() {
		...
		arguments.getProjection(Boolean.TRUE).addFromTuple("t",RequestScopeFunction.FIELD_IDENTIFIER,"request.identifier","scopeFunction.identifier",RequestScopeFunction.FIELD_GRANTED)
