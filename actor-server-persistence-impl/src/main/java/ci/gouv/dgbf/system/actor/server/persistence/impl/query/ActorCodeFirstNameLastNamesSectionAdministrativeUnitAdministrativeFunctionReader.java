...
public class ActorCodeFirstNameLastNamesSectionAdministrativeUnitAdministrativeFunctionReader extends AbstractActorReaderImpl implements Serializable {
	...
	protected String getQueryValue() {
		...
		arguments.getProjection(Boolean.TRUE).addFromTuple("i", Identity.FIELD_FIRST_NAME,Identity.FIELD_LAST_NAMES,Identity.FIELD_ADMINISTRATIVE_FUNCTION);
