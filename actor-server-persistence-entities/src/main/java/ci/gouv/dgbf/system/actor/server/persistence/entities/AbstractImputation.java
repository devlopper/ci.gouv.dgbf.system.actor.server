...
public abstract class AbstractImputation extends AbstractIdentifiableSystemScalarStringIdentifiableBusinessStringNamableImpl implements Serializable {
	...
	@Column(name = COLUMN_BUDGET_SPECIALIZATION_UNIT_IDENTIFIER) private String budgetSpecializationUnitIdentifier;
	...
	@Column(name = COLUMN_ACTION_IDENTIFIER) private String actionIdentifier;
	...
	@Column(name = COLUMN_ECONOMIC_NATURE_IDENTIFIER) private String economicNatureIdentifier;
	...
	@Column(name = COLUMN_ADMINISTRATIVE_UNIT_IDENTIFIER) private String administrativeUnitIdentifier;
