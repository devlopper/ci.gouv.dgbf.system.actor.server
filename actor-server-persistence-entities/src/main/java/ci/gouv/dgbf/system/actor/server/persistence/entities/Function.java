...
public class Function extends AbstractIdentifiableSystemScalarStringIdentifiableBusinessStringNamableImpl implements Serializable {
	...
	public static final Collection<String> EXECUTION_HOLDERS_CODES_HAVING_SIGNATURE_SPECIMEN = List.of(CODE_CREDIT_MANAGER_HOLDER,CODE_AUTHORIZING_OFFICER_HOLDER);
